...
int main()
{
  ...
  Ort::Session* img_encoder_session = new Ort::Session(img_encoder_env, "checkpoints/ailia/v2_1/tiny/image_encoder_hiera_t_2.1.onnx", img_encoder_options);
  ...
  int img_encoder_out_image_embed_idx = tensorByName(img_encoder_out, img_encoder_output_names, "vision_features");
  int img_encoder_out_high_res_features1_idx = tensorByName(img_encoder_out, img_encoder_output_names, "backbone_fpn_0");
  int img_encoder_out_high_res_features2_idx = tensorByName(img_encoder_out, img_encoder_output_names, "backbone_fpn_1");
  ...
  */
  ...
  printf("Creating img_decoder_input_tensor (points, labels)\n");
  ...
  printf("Creating img_decoder_input_tensor (mask input)\n");
  ...
  printf("Creating img_decoder_input_tensor (image size)\n");
  ...
  int img_decoder_out_iou_predictions_idx = tensorByName(img_decoder_out, img_decoder_output_names, "iou_predictions");
  ...
  int img_decoder_out_masks_idx = tensorByName(img_decoder_out, img_decoder_output_names, "masks");
